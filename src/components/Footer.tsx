        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-300 text-lg leading-relaxed mb-6 max-w-md">
              A boutique digital agency specializing in branding, UI/UX design, full-stack development, 
              and cutting-edge AI solutions. We transform ideas into exceptional digital experiences.
            </p>
